defmodule SocialScribe.SalesforceTokenRefresher do
  ...
  Note: Salesforce typically doesn't rotate refresh tokens.
  """
  ...
  def refresh_credential(credential) do
    ...
    case refresh_token(credential.refresh_token) do
      {:ok, response} ->
        # Salesforce returns expires_in in seconds; default to 3600 if missing
        ...
        # Note: Salesforce typically doesn't return new refresh_token, keep existing one
